...
import FacilityTaskAddComponent from '../add/FacilityTaskAddComponent';
import './FacilityTaskListComponent.scss';
//import { AddRounded } from '@material-ui/icons';
//import Filter from '@material-ui/icons/FilterList';
//import SearchIcon from '@material-ui/icons/SearchOutlined';

const FacilityTaskListComponent = () => {
    const [isList, setIsList] = useState<boolean>(true);
    //const [task, setTask] = React.useState<any>([])


    return !isList ? <FacilityTaskAddComponent setIsList={setIsList} /> : <FacilityTaskList setIsList={setIsList} />
}


const FacilityTaskList = (props: any) => {
    // const { tasks } = props
    ...
    return <div className='facility-task-list'>
        ...
        {/* {
            tasks.length > 0 && tasks.map((item: any, index: number) => {
                return <FacilityTaskCard anchorEl={anchorEl} open={open} handleClick={handleClick} handleClose={handleClose} />
            })
        }  */}
    </div>
...
// const FacilityTaskCard = (props: any) => {
...
export default FacilityTaskListComponent;
